...
const IntroPage = ({ onNext }) => (
  <div className=" tw-relative tw-h-screen tw-flex tw-items-center tw-justify-center tw-bg-black"> 
    ...
    <div className="tw-relative tw-text-center tw-text-white tw-p-8 tw-space-y-4">
      <h1 className="tw-text-4xl font-baskervville tw-tracking-wide tw-uppercase tw-text-shadow-lg"  style={{ fontFamily: 'Satoshi, serif' }}>
        WE INVITE YOU TO CELEBRATE
      </h1>
      <h2 className="tw-text-6xl font-tirelessly tw-tracking-tight tw-text-shadow-xl">
        Hanson & Catherine
      </h2>
      <p className="tw-text-3xl  tw-text-shadow-md">SATURDAY, 02 MARCH 2024</p>
      <p className="tw-text-2xl  tw-text-shadow-sm">Dear</p>
      <p className="tw-text-2xl  tw-text-shadow-sm">Nama Tamu</p>
      <button
        onClick={onNext}
    ...
    <div>
      ...
      <div className="tw-relative tw-h-screen tw-flex tw-items-center tw-justify-center tw-bg-cover" style={{ backgroundImage: "url('/public/image/bride-bg.jpeg')" }}>
        ...
        <div className="tw-absolute tw-bottom-10 tw-w-full tw-flex tw-justify-center">
          <div className="tw-w-1/4 tw-overflow-hidden tw-relative">
            <Slider {...settings}>
